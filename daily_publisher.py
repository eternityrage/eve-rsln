...
def generate_caption():
    ...
    fallback_titles = [
        "Floral-Inspired Outfit Ideas for Soft, Elegant Style",
        "Everyday Beauty Routine for a Natural Glow",
        "Finding Beauty in the Little Things: A Slow Day",
        "Travel Diary: A Romantic Escape Worth Saving",
        "How to Build a Timeless Capsule Wardrobe",
        "Soft Glam Makeup for a Beautiful Evening",
        "Photography Tips for Capturing Everyday Moments",
        "Wellness Rituals That Help Me Feel Beautiful",
        "Chic Airport Looks for Stylish Travel",
        "Personal Style Inspiration: Dressing for Joy",
        "Cozy Knitwear Looks for Gentle Days",
        "Beauty in Bloom: My Favorite Floral Fashion",
    ...
    vibes = [
        "soft and elegant — make viewers want to embrace floral, feminine style",
...
def main():
    ...
    # YouTube Shorts
    try:
        upload_to_youtube(video_path, title, description, tags=["fashion", "beauty", "lifestyle", "travel", "style", "floral", "photography", "wellness", "evelinaroselle", "ootd", "skincare", "selfcare", "inspiration", "livebeautifully"])
